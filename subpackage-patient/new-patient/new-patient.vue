<template>
	<view>
		...
		<view class="form mx-3">
            ...
            hideKeyboard();
          " ref="item1">
					<u--input v-model="patientInfo.gender" disabled disabledColor="#ffffff" placeholder="请选择性别"
						border="none"></u--input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				<u-form-item label="出生日期:" labelWidth="150rpx" prop="birthday" borderBottom @click="
            showBirthday = true;
            hideKeyboard();
          " ref="item1">
					<u--input v-model="patientInfo.birthday" disabled disabledColor="#ffffff" placeholder="请选择生日"
						border="none"></u--input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
			...
			<u-datetime-picker :minDate="-946770632000" :show="showBirthday" :value="birthday" mode="date"
